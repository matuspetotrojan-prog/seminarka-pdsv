...
,,Washington State Department of Transportation (WSDOT) vyvinul digitálne dvojča plávajúceho mosta I-90, čo viedlo k vylepšenému monitorovaniu konštrukcie a odhadovanému návratu investícií až 2000\% ''\cite{tech_report_2025}.
...
,,Autonómne vozidlá sú založené na rôznych senzoroch, ako sú GPS, kamery a radary, v kombinácii s aktuátormi, riadiacimi jednotkami a softvérom'' \cite{EPRS_2019}.
...
,,Testovanie plne autonómnych vozidiel prebieha v obmedzenom počte jazdných situácií a oblastí'' \cite{EPRS_2019}.
