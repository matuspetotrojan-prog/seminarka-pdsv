...
,,Ministerstvo dopravy USA (USDOT) v spolupráci s Federálnou správou diaľnic (FHWA), Federálnou železničnou správou (FRA) a Federálnou leteckou správou (FAA) začalo aktívne preskúmať potenciál AI v dopravnom ekosystéme'' \cite{tech_report_2025}.
...
V cestnej doprave sa AI aplikuje najviditeľnejšie.
...
,,Predpokladá sa, že AI prispeje k vytvoreniu nových pracovných miest, zániku iných a zmene väčšiny'' \cite{EPRS_2019}. 
